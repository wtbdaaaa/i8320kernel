			...
			struct v4l2_format *f)
{
	...
	if (vout->pix.height * vout->pix.width == VID_MAX_WIDTH * 720)
	{
		...
		omap_pm_set_min_mpu_freq(((vout->vid_dev)->v4l2_dev).dev, VDD1_OPP5_FREQ);
#endif
	}
	else
	{
...
static int vidioc_streamon(struct file *file, void *fh, enum v4l2_buf_type i)
{
	...
	*		  
	*/
	omap_pm_set_min_mpu_freq(((vout->vid_dev)->v4l2_dev).dev, VDD1_OPP5_FREQ); //temp... original VDD1_OPP3_FREQ
#endif
