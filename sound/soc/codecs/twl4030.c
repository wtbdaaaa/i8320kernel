...
static const char *playback_path[]  = {"off","RCV","SPK","HP","4HP", "BT","SPK_HP", "EXTRA_DOCK_SPEAKER"};//me change 2012.04.26
...
static const char *fmradio_path[]=        	{"off","RCV","SPK","HP"};//me change 2012.04.26
static const char *loopback_path[]=      {"off","RCV","SPK","HP"};//me change 2012.04.26
...
twl4030_codec_setting voicecall_rcv[]={
 ...
 // {0x21, 0x34},  //TWL4030_REG_EAR_CTL//me open
  {0x3a, 0x16},  //TWL4030_REG_APLL_CTL
...
static int twl4030_set_voicecall_path(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_value *ucontrol,unsigned int codec_mode)
{
	...
	switch(ucontrol->value.integer.value[0])
	{
		...
		//twl4030_write(codec, 0x43, 0x10);  //TWL4030_REG_RX_PATH_SEL
                twl4030_write(codec, 0x43, 0x00);  //TWL4030_REG_RX_PATH_SEL//me change
		//twl4030_write(codec, 0x3f, 0xa0);  //TWL4030_REG_PCMBTMUX
                twl4030_write(codec, 0x3f, 0xa5);  //TWL4030_REG_PCMBTMUX//me change
	...
	switch(ucontrol->value.integer.value[0])
	{
		...
		case SPK:
			...
			//twl4030_write(codec, 0x25,0x24);   //TWL4030_PREDL_CTL
                        twl4030_write(codec, 0x26,0x38);   //TWL4030_PREDR_CTL //me change 2012.04.26
			twl4030_write(codec, 0x25,0x34);   //TWL4030_PREDL_CTL //me change 2012.04.26
		break;
