...
//				twl4030_modify(codec, 0x1C, (0x0 << 3), ARX_APGA_GAIN_MASK); //ARXR2_APGA_CTL [3:7]
			...
			case HP4P: 
				...
				//TX Common
				//twl4030_write(codec, 0x48, 0x24); // ANAMIC_GAIN (L[0:2], R[3:5])
				//twl4030_write(codec, 0x48, (0x0 << 3) | 0x1); // ANAMIC_GAIN (L[0:2], R[3:5])//me close 2012.05.08
                                twl4030_write(codec, 0x48, (0x0 << 3) | 0x3); // ANAMIC_GAIN (L[0:2], R[3:5])//me change 2012.05.08
			...
			case BT: 
#ifndef APPLY_AUDIOTEST_APP
				//twl4030_write(codec, 0x1F, (0x5 << 4)| 0x5); //BTPGA(RX[0:3], Tx[4:7])//me close 2012.05.08
                                twl4030_write(codec, 0x1F, (0x9 << 4)| 0x9); //BTPGA(RX[0:3], Tx[4:7])//me change 2012.05.08
#else
				if(!get_sec_gain_test_mode())
