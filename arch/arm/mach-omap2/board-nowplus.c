  ...
  static struct omap_board_mux board_mux[] __initdata = {
	...
	//"MMC1 CMD"
 	...
 	//"MOVI COMMAND"
        ...
        //"MOVI DATA 4"
        OMAP3_MUX(SDMMC2_DAT4,          OMAP34XX_MUX_MODE7),
        //"MOVI DATA 5"
...
//        OMAP3_MUX(MCBSP3_CLKX,          OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT_PULLUP | OMAP34XX_PIN_OFF_NONE),//me ok
	...
	OMAP3_MUX(I2C3_SDA,  OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_INPUT_PULLUP | OMAP34XX_PIN_OFF_OUTPUT_LOW),
       ...
       OMAP3_MUX(HDQ_SIO,              OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT_PULLUP),
        ...
        //"WLAN IRQ"
        //OMAP3_MUX(ETK_D7,                     OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT_PULLDOWN),//???//me ok
...
static struct regulator_init_data nowplus_vsim = {
	.constraints = {
		.min_uV			= 1800000,
		.max_uV			= 1800000,//3000000,//me change 2012.04.18
		.always_on		= true,            
		.boot_on		= true,				
		.valid_modes_mask	= REGULATOR_MODE_NORMAL
					| REGULATOR_MODE_STANDBY,
