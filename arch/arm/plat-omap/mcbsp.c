...
static irqreturn_t omap_mcbsp_tx_irq_handler(int irq, void *dev_id)
{
	...
	u16 irqst_spcr2;
#if 1//TI HS.Yoon 20100930 DMB noise patch
	u16 irq_status;
#endif
	irqst_spcr2 = MCBSP_READ(mcbsp_tx, SPCR2);
#if 1//TI HS.Yoon 20100930 DMB noise patch
	irq_status = MCBSP_READ(mcbsp_tx, IRQST);	
#endif
...
void omap_mcbsp_start(unsigned int id, int tx, int rx)
{
	...
	mcbsp = id_to_mcbsp_ptr(id);
#if 1//TI HS.Yoon 20100930 DMB noise patch
	irqen=MCBSP_READ_CACHE(mcbsp, IRQEN);
        MCBSP_WRITE(mcbsp, IRQEN, irqen | (XOVFLSTAT));
#endif
